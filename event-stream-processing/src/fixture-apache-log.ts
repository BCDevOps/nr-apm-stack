const apache_request_time = '05/Jun/2020:19:21:54 -0700';
const apache_internal_ip = '172.30.1.12';
...
export const APACHE_LOG_COMBINED_KEEPALIVE = {
  message: `${apache_internal_ip} - - [${apache_request_time}] "GET /keepalive.html HTTP/1.1" 200 9 "-" "-"`,
};
...
export const APACHE_LOG_V1_APEX_1 = `v1.0 20120211 "http://a100.gov.bc.ca:80" "${apache_internal_ip}" [04/Jun/2021:10:00:51 -0700] "GET /pub/apex/f?p=200:1:1177634512958: HTTP/1.1" 302 251 bytes 520 bytes "-" "-" 17 ms, "-" "-"`;
