...
describe('RegexService', () => {
  ...
  it('parses Windows IIS entry - 003', () => {
    ...
    expect(document.data).toHaveProperty('url.port', '443');
    expect(metaFields.userName).toBe('IDIR\JELINDLE');
