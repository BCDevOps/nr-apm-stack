...
describe('RegexService', () => {
  ...
  it('parses Windows IIS entry - 001', () => {
    ...
    expect(document.data).toHaveProperty('server.ip', '142.34.2.162');
