...
import {KinesisStreamService} from '../src/kinesis-stream.service';
...
import {MaxmindAsnLookup, MaxmindCityLookup} from '../src/util/maxmindLookup.service';
...
test('apache - safe uri', async () => {
  ...
  const handler = myContainer.get<KinesisStreamService>(TYPES.KinesisStreamService);
