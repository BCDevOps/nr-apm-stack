...
export async function describeDomain(client: ElasticsearchServiceClient, domainName: string):
...
export async function waitForDomainStatusReady(client: ElasticsearchServiceClient, domainName: string):
